...
import { createOrgTraining } from "../../actions/organization/org_training_action";
const CreateOrgTrainingPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(createOrgTraining(traning));
  };
  if (state.is_done) {
    // setTraining({
    //   name: "",
    ...
    //   link: "",
    // });
    return <Navigate to="/org/all-trainings" />;
  }
...
export default CreateOrgTrainingPage;
